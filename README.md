...
We strongly encourage you to join the IRC channel associated with this project in order to be informed about project updates and other important announcements, as well as to be reachable in the event of an issue. The Archive Team Wiki has [more information about IRC](https://wiki.archiveteam.org/index.php/Archiveteam:IRC). We can be found at hackint IRC [#wuciyuan](https://webirc.hackint.org/#irc://irc.hackint.org/#wuciyuan).
...
after which the project can be run:
    ...
    docker run --name archiveteam --label=com.centurylinklabs.watchtower.enable=true --restart=unless-stopped atdr.meo.ws/archiveteam/banciyuan-grab --concurrent 1 YOURNICKHERE
...
Have an issue not listed here? Join us on IRC and ask! We can be found at hackint IRC [#wuciyuan](https://webirc.hackint.org/#irc://irc.hackint.org/#wuciyuan).
